...
**Remark** \newline
$E[Y^{(1)}] - E[Y^{(-1)}]$ is the interested causation but is unobservable in real world. By **unconfoundedness** and **positivity**, we infer the unobservable causation via observed data, i.e., $E[Y \mid T = 1] - E[Y \mid T = -1]$, which is also known as association. In general, association does not imply causation. 
