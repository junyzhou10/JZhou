...
```{r SimpleTest, echo=F, fig.width=8, fig.height=7, fig.cap="Simple examples of Wald's method and the proposed improved method with estimated c. Panel (a) and (b): univariate model $logit(Pr(y=1)) = 1.2X$; Panel (c) and (d): multivariate model $logit(Pr(y=1)) = -1+2X_1+4X_2-X_3-2X_4+X_5$, and we know the true model during fitting."}
set.seed(20200610)
N = 500000
p = 1
